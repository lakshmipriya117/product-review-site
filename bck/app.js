...
const Suggdata = require("./src/model/SuggData");
var app = new express();
app.use(cors());
...
app.post('/insert', function(req,res){
    ...
    var review = {
     ...
     proRating: req.body.review.proRating,
...
app.post('/in',function(req,res){
    var suggest={
        name:req.body.suggest.name,
       
        genre:req.body.suggest.genre,
        desc:req.body.suggest.desc
    }
    var suggest=Suggdata(suggest);
    suggest.save();
});
app.get('/suggests',function(req,res){
    Suggdata.find()
